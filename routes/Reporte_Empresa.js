        ...
        function (req,res) {
            ...
            categoria.findEmpresa(function (ere,data) {
                if (!ere) {
                    ...
                    categoria.getAllExt(function (er,da) {
                        if (!er) {
...
router.post('/:id/estado',function (req,res,next) {
    ...
    console.log(estado);
    reporteEmpresa.estado(estado,function (err, data) {
        if (!err){
            console.log(data)
...
router.post('/:id/prio',function (req,res,next) {
    ...
    var estado =[req.body.estado,req.params.id]
    console.log(estado);
    reporteEmpresa.prio(estado,function (err, data) {
        if (!err){
            console.log(data)
            //res.status(200).json(data);
            res.send("ok");
...
router.post('/:id/cat',function (req,res,next) {
    ...
    var estado =[req.body.estado,req.params.id]
    console.log(estado);
    reporteEmpresa.cat(estado,function (err, data) {
        if (!err){
            console.log(data)
            //res.status(200).json(data);
            res.send("ok");
...
router.post('/:id/oper',function (req,res,next) {
    ...
    var estado =[req.body.estado,req.params.id]
    console.log(estado);
    reporteEmpresa.oper(estado,function (err, data) {
        if (!err){
            console.log(data)
            //res.status(200).json(data);
            res.send("ok");
